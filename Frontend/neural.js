...
function findWasmBinary() {
  if (Module['locateFile']) {
    return locateFile('neural.wasm');
  }
  // Use bundler-friendly `new URL(..., import.meta.url)` pattern; works in browsers too.
  return new URL('neural.wasm', import.meta.url).href;
}
...
var _cost = Module['_cost'] = createExportWrapper('cost', 1);
var _train_network = Module['_train_network'] = createExportWrapper('train_network', 4);
